...
const Subscriptions = () => {
    ...
    // Estado para guardar lo que escribes en el formulario
    ...
    // Simulando que sacamos el ID de tu sesión (asegúrate de que sea tu ID real)
    ...
    // 2. Función para enviar el nuevo gasto al servidor
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Cerramos el modal, limpiamos el formulario y recargamos los datos
            ...
            {isModalOpen && (
                <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', backgroundColor: 'rgba(0,0,0,0.4)', backdropFilter: 'blur(5px)', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: 1000 }}>
                    <div style={{ backgroundColor: '#fff', padding: '30px', borderRadius: '24px', width: '90%', maxWidth: '400px', boxShadow: '0 20px 40px rgba(0,0,0,0.2)' }}>
                        <h2 style={{ marginTop: 0, marginBottom: '20px', fontSize: '24px' }}>Nuevo gasto</h2>
                        ...
                        <form onSubmit={handleSubmit}>
                            <input 
                                ...
                                style={{ width: '100%', padding: '14px', marginBottom: '15px', border: '1px solid #ddd', borderRadius: '12px', fontSize: '16px', boxSizing: 'border-box' }}
                            />
                            <input 
                                type="number" 
                            ...
                            <input 
                                ...
                                style={{ width: '100%', padding: '14px', marginBottom: '25px', border: '1px solid #ddd', borderRadius: '12px', fontSize: '16px', boxSizing: 'border-box' }}
                            />
